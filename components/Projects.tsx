...
function Projects({}: Props) {
  ...
  return (
    ...
    >
      ...
      snap-mandatory z-20 scrollbar-thin scroll-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80"
      >
        {projects.map((project, index) => (
          ...
          >
            <motion.div initial={{ y: -300, opacity: 0 }} transition={{ duration: 1.2 }} whileInView={{ opacity: 1, y: 0 }}>
              <Image
                className="object-center rounded-full border border-gray-500 object-cover w-24 h-24 xl:w-32
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <p>Learning to be a better web developer.</p>
            </div>
          </div>
        ))}
      </div>
